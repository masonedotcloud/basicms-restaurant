...
superadminOnly(); #controllo se ha i permessi per vedere questa pagine
...
<div class="container">
    <div class="row mt-1  mb-4">
        ...
        <!--Pulsante nella home-->
        <div class="col-lg-4 col-md-6 d-flex justify-content-center align-items-center pt-3">
            <a href="user-index.php" class="d-flex justify-content-center align-items-center btn btn-light flex-column white shadow " style="height: 260px; width: 100%; border-radius:25px;">
